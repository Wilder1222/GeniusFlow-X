...
export async function GET(req: NextRequest) {
    try {
        ...
        const sortBy = (searchParams.get('sortBy') as BrowseCardsQuery['sortBy']) || 'created_at';
        const sortOrder = (searchParams.get('sortOrder') as BrowseCardsQuery['sortOrder']) || 'desc';
